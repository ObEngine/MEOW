...
public:
  ...
  ///
  ////////////////////////////////////////////////////////////
  bool saveToMemory(std::vector<meow::Uint8> &output,
  ...
  /// kind of feature in real-time you'd better use meow::RenderTexture.
  ///
...
/// \ingroup graphics
///
/// meow::Image is an abstraction to manipulate images
/// as bidimensional arrays of pixels. The class provides
/// functions to load, read, write and save pixels, as well
/// as many other useful functions.
///
/// meow::Image can handle a unique internal representation of
/// pixels, which is RGBA 32 bits. This means that a pixel
/// must be composed of 8 bits red, green, blue and alpha
/// channels -- just like a meow::Color.
/// All the functions that return an array of pixels follow
/// this rule, and all parameters that you pass to meow::Image
/// functions (such as loadFromMemory) must use this
/// representation as well.
///
/// A meow::Image can be copied, but it is a heavy resource and
...
/// meow::Image background;
/// if (!background.loadFromFile("background.jpg"))
///     return -1;
///
/// // Create a 20x20 image filled with black color
/// meow::Image image;
/// image.create(20, 20, meow::Color::Black);
///
/// // Copy image1 on image2 at position (10, 10)
/// image.copy(background, 10, 10);
///
/// // Make the top-left pixel transparent
/// meow::Color color = image.getPixel(0, 0);
/// color.a = 0;
