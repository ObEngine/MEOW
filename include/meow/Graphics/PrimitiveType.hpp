...
////////////////////////////////////////////////////////////
/// \ingroup graphics
/// \brief Types of primitives that a meow::VertexArray can render
///
...
enum PrimitiveType {
  ...
  TriangleStrip, //!< List of connected triangles, a point uses the two previous
                 //!< points to form a triangle
  TriangleFan, //!< List of connected triangles, a point uses the common center
