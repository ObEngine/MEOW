...
public:
  ...
  /// to using meow::RenderStates::Default.
...
/// function: meow::RenderStates has an implicit one-argument
...
/// object (inherited from meow::Drawable), you can
...
/// set its texture. Etc.
///
/// \see meow::RenderTarget, meow::Drawable
///
////////////////////////////////////////////////////////////
