...
public:
  ...
  /// The internal meow::Texture of a render-texture is always the
...
////////////////////////////////////////////////////////////
/// \class meow::RenderTexture
/// \ingroup graphics
///
/// meow::RenderTexture is the little brother of meow::RenderWindow.
/// It implements the same 2D drawing and OpenGL-related functions
/// (see their base class meow::RenderTarget for more details),
...
///    texture.clear(meow::Color::Red);
///
///    // Draw stuff to the texture
///    texture.draw(sprite);  // sprite is a meow::Sprite
///    texture.draw(shape);   // shape is a meow::Shape
///    texture.draw(text);    // text is a meow::Text
///
...
///
///    // Draw the texture
///    meow::Sprite sprite(texture.getTexture());
///    window.draw(sprite);
///
...
/// \endcode
///
/// Like meow::RenderWindow, meow::RenderTexture is still able to render direct
/// OpenGL stuff. It is even possible to mix together OpenGL calls
/// and regular SFML drawing commands. If you need a depth buffer for
/// 3D rendering, don't forget to request it when calling RenderTexture::create.
///
/// \see meow::RenderTarget, meow::RenderWindow, meow::View, meow::Texture
///
////////////////////////////////////////////////////////////
