...
public:
  ...
  /// mix meow::Texture with OpenGL code.
  ///
  /// \code
  /// meow::Texture t1, t2;
  /// ...
  /// meow::Texture::bind(&t1);
  /// // draw OpenGL stuff that use t1...
  /// meow::Texture::bind(&t2);
  /// // draw OpenGL stuff that use t2...
  /// meow::Texture::bind(NULL);
...
/// \ingroup graphics
///
/// meow::Texture stores pixels that can be drawn, with a sprite
...
/// A texture cannot be manipulated as freely as a meow::Image,
/// you need to prepare the pixels first and then upload them
/// to the texture in a single operation (see Texture::update).
///
/// meow::Texture makes it easy to convert from/to meow::Image, but
...
/// meow::Image, do whatever you need with the pixels, and then call
...
/// of booleans.
///
/// Like meow::Image, meow::Texture can handle a unique internal
/// representation of pixels, which is RGBA 32 bits. This means
/// that a pixel must be composed of 8 bits red, green, blue and
/// alpha channels -- just like a meow::Color.
///
/// Usage example:
/// \code
/// // This example shows the most common use of meow::Texture:
/// // drawing a sprite
///
...
///
/// \code
/// // This example shows another common use of meow::Texture:
...
///
///     // update the texture
///     meow::Uint8* pixels = ...; // get a fresh chunk of pixels (the next
///     frame of a movie, for example) texture.update(pixels);
///
///     // draw it
///     window.draw(sprite);
///
...
/// \endcode
///
/// Like meow::Shader that can be used as a raw OpenGL shader,
/// meow::Texture can also be used directly as a raw texture for
/// custom OpenGL geometry.
/// \code
/// meow::Texture::bind(&texture);
/// ... render OpenGL geometry ...
/// meow::Texture::bind(NULL);
/// \endcode
///
/// \see meow::Sprite, meow::Image, meow::RenderTexture
///
////////////////////////////////////////////////////////////
