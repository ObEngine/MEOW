...
public:
  ...
  /// \code
  /// meow::Vector2f transformedPoint = matrix.transformPoint(x, y);
  /// meow::Vector2f transformedPoint = matrix * meow::Vector2f(x, y);
  /// \endcode
  ///
  ...
  /// These two statements are equivalent:
  /// \code
  /// meow::Vector2f transformedPoint = matrix.transformPoint(point);
  /// meow::Vector2f transformedPoint = matrix * point;
  /// \endcode
  ///
  ...
  /// \code
  /// meow::Transform transform;
  /// transform.translate(meow::Vector2f(100, 200)).rotate(45);
  /// \endcode
  ///
  ...
  /// \code
  /// meow::Transform transform;
  /// transform.rotate(90, meow::Vector2f(8, 3)).translate(meow::Vector2f(50,
  /// 20)); \endcode
  ///
  /// \param angle Rotation angle, in degrees
  ...
  /// \code
  /// meow::Transform transform;
  /// transform.scale(meow::Vector2f(2, 1)).rotate(45);
  /// \endcode
  ///
  ...
  /// \code
  /// meow::Transform transform;
  /// transform.scale(meow::Vector2f(2, 1), meow::Vector2f(8, 3)).rotate(45);
  /// \endcode
  ///
  /// \param factors Scaling factors
...
////////////////////////////////////////////////////////////
/// \class meow::Transform
/// \ingroup graphics
///
/// A meow::Transform specifies how to translate, rotate, scale,
...
/// meow::Transform translation;
/// translation.translate(20, 50);
///
/// // define a rotation transform
/// meow::Transform rotation;
/// rotation.rotate(45);
///
/// // combine them
/// meow::Transform transform = translation * rotation;
///
/// // use the result to transform stuff...
/// meow::Vector2f point = transform.transformPoint(10, 20);
/// meow::FloatRect rect = transform.transformRect(meow::FloatRect(0, 0, 10,
/// 100)); \endcode
///
/// \see meow::Transformable, meow::RenderStates
///
////////////////////////////////////////////////////////////
