...
public:
  ...
  /// \code
  /// meow::Vector2f pos = object.getPosition();
  ...
  /// Thus, it is equivalent to the following code:
  /// \code
  /// meow::Vector2f scale = object.getScale();
...
////////////////////////////////////////////////////////////
/// \class meow::Transformable
/// \ingroup graphics
///
/// This class is provided for convenience, on top of meow::Transform.
///
/// meow::Transform, as a low-level class, offers a great level of
...
///
/// That's exactly what meow::Transformable was written for: it hides
...
/// transform (as a meow::Transform), and keeps it up-to-date.
///
/// In addition to the position, rotation and scale, meow::Transformable
...
/// bottom-right corner.
///
/// To keep the meow::Transformable class simple, there's only one
/// origin for all the components. You cannot position the sprite
/// relatively to its top-left corner while rotating it around its
/// center, for example. To do such things, use meow::Transform directly.
///
/// meow::Transformable can be used as a base class. It is often
/// combined with meow::Drawable -- that's what SFML's sprites,
/// texts and shapes do.
/// \code
/// class MyEntity : public meow::Transformable, public meow::Drawable
/// {
...
///     }
///
///     void Draw(meow::RenderTarget& target) const
///     {
///         target.draw(..., myTransform.getTransform());
///     }
///
/// private:
///     meow::Transformable myTransform;
/// };
/// \endcode
///
...
/// In order to render a meow::Drawable object pixel-perfectly, make sure
