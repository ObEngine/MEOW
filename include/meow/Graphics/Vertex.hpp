...
/// meow::Vertex vertices[] =
/// {
///     meow::Vertex(meow::Vector2f(  0,   0), meow::Color::Red, meow::Vector2f(
///     0, 0)), meow::Vertex(meow::Vector2f(  0, 100), meow::Color::Red,
///     meow::Vector2f( 0, 10)), meow::Vertex(meow::Vector2f(100, 100),
///     meow::Color::Red, meow::Vector2f(10, 10)),
///     meow::Vertex(meow::Vector2f(100,   0), meow::Color::Red,
///     meow::Vector2f(10,  0))
/// };
///
/// // draw it
/// window.draw(vertices, 4, meow::Quads);
/// \endcode
///
