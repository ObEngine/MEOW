...
#include <meow/Graphics/PrimitiveType.hpp>
...
public:
  ...
  ///
  /// The default primitive type is meow::Points.
  ///
  /// \param type Type of primitive
  ///
  ////////////////////////////////////////////////////////////
  ...
  /// take effect.
  ///
  /// The default primitive type is meow::VertexBuffer::Stream.
  ///
  /// \param usage Usage specifier
  ///
  ////////////////////////////////////////////////////////////
  ...
  /// mix meow::VertexBuffer with OpenGL code.
  ///
  /// \code
  /// meow::VertexBuffer vb1, vb2;
  /// ...
  /// meow::VertexBuffer::bind(&vb1);
  /// // draw OpenGL stuff that use vb1...
  /// meow::VertexBuffer::bind(&vb2);
  /// // draw OpenGL stuff that use vb2...
  /// meow::VertexBuffer::bind(NULL);
  ...
  /// any attempt to use meow::VertexBuffer will fail.
  ///
...
////////////////////////////////////////////////////////////
/// \class meow::VertexBuffer
/// \ingroup graphics
///
/// meow::VertexBuffer is a simple wrapper around a dynamic
/// buffer of vertices and a primitives type.
///
/// Unlike meow::VertexArray, the vertex data is stored in
/// graphics memory.
///
/// In situations where a large amount of vertex data would
/// have to be transferred from system memory to graphics memory
/// every frame, using meow::VertexBuffer can help. By using a
/// meow::VertexBuffer, data that has not been changed between frames
/// does not have to be re-transferred from system to graphics
/// memory as would be the case with meow::VertexArray. If data transfer
/// is a bottleneck, this can lead to performance gains.
///
/// Using meow::VertexBuffer, the user also has the ability to only modify
...
///
/// It inherits meow::Drawable, but unlike other drawables it
/// is not transformable.
///
/// Example:
/// \code
/// meow::Vertex vertices[15];
/// ...
/// meow::VertexBuffer triangles(meow::Triangles);
/// triangles.create(15);
...
/// \endcode
///
/// \see meow::Vertex, meow::VertexArray
///
////////////////////////////////////////////////////////////
