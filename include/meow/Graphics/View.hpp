...
public:
  ...
  /// be defined with View.setViewport(meow::FloatRect(0, 0, 0.5, 1)).
...
/// \ingroup graphics
///
/// meow::View defines a camera in the 2D scene. This is a
...
/// Usage example:
/// \code
/// meow::RenderWindow window;
/// meow::View view;
///
/// // Initialize the view to a rectangle located at (100, 100) and with a size
/// of 400x200 view.reset(meow::FloatRect(100, 100, 400, 200));
///
/// // Rotate it by 45 degrees
/// view.rotate(45);
///
/// // Set its target viewport to be half of the window
/// view.setViewport(meow::FloatRect(0.f, 0.f, 0.5f, 1.f));
///
/// // Apply it
/// window.setView(view);
///
...
/// meow::Transformable.
///
/// \see meow::RenderWindow, meow::RenderTexture
///
////////////////////////////////////////////////////////////
