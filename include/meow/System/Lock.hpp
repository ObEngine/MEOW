...
public:
  ...
  ///
  /// The mutex passed to meow::Lock is automatically locked.
  ///
  ...
  /// \brief Destructor
  ///
  /// The destructor of meow::Lock automatically unlocks its mutex.
  ///
  ////////////////////////////////////////////////////////////
  ~Lock();
...
/// \ingroup system
///
/// meow::Lock is a RAII wrapper for meow::Mutex. By unlocking
...
/// function.
///
/// For maximum robustness, meow::Lock should always be used
...
/// void function()
/// {
///     meow::Lock lock(mutex); // mutex is now locked
///
