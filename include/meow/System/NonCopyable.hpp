...
protected:
  ...
  /// call delete on a pointer of meow::NonCopyable, thus
...
/// in meow::NonCopyable so they will end up being inaccessible in both
/// cases. Thus you can use a shorter syntax for inheriting from it
/// (see below).
///
/// Usage example:
/// \code
/// class MyNonCopyableClass : meow::NonCopyable
/// {
///     ...
/// };
/// \endcode
...
/// and to use meow::NonCopyable when necessary to prevent
