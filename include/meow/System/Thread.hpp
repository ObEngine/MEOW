...
public:
  ...
  /// cannot survive after its meow::Thread instance is destroyed.
  ///
  ////////////////////////////////////////////////////////////
  ~Thread();
...
#include <meow/System/Thread.inl>
...
/// in parallel.
///
/// To use a meow::Thread, you construct it directly with the
/// function to execute as the entry point of the thread.
/// meow::Thread has multiple template constructors, which means
...
///
/// The function argument, if any, is copied in the meow::Thread
...
/// owner meow::Thread instance is destroyed before the
...
/// }
///
/// meow::Thread thread(&threadFunc, 5);
...
///
/// Task task;
/// meow::Thread thread(&Task::run, &task);
...
/// kind of situations, you can use mutexes (see meow::Mutex).
///
/// \see meow::Mutex
///
////////////////////////////////////////////////////////////
