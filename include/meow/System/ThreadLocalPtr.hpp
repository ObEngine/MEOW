...
#include <meow/System/ThreadLocalPtr.inl>

#endif // SFML_THREADLOCALPTR_HPP

////////////////////////////////////////////////////////////
/// \class meow::ThreadLocalPtr
/// \ingroup system
///
/// meow::ThreadLocalPtr is a type-safe wrapper for storing
...
/// MyClass object1;
/// MyClass object2;
/// meow::ThreadLocalPtr<MyClass> objectPtr;
///
/// void thread1()
/// {
...
///     meow::Thread t1(&thread1);
///     meow::Thread t2(&thread2);
///     t1.launch();
///     t2.launch();
///
///     return 0;
