...
public:
  ...
  /// ------------------------------------|:-----:|:--------:|:--------:|
  ///  meow::Cursor::Arrow                  |  yes  |    yes   |   yes    |
  ///  meow::Cursor::ArrowWait              |  no   |    no    |   yes    |
  ///  meow::Cursor::Wait                   |  yes  |    no    |   yes    |
  ///  meow::Cursor::Text                   |  yes  |    yes   |   yes    |
  ///  meow::Cursor::Hand                   |  yes  |    yes   |   yes    |
  ///  meow::Cursor::SizeHorizontal         |  yes  |    yes   |   yes    |
  ///  meow::Cursor::SizeVertical           |  yes  |    yes   |   yes    |
  ///  meow::Cursor::SizeTopLeftBottomRight |  no   |    yes*  |   yes    |
  ///  meow::Cursor::SizeBottomLeftTopRight |  no   |    yes*  |   yes    |
  ///  meow::Cursor::SizeLeft               |  yes  |    yes** |   yes**  |
  ///  meow::Cursor::SizeRight              |  yes  |    yes** |   yes**  |
  ///  meow::Cursor::SizeTop                |  yes  |    yes** |   yes**  |
  ///  meow::Cursor::SizeBottom             |  yes  |    yes** |   yes**  |
  ///  meow::Cursor::SizeTopLeft            |  yes  |    yes** |   yes**  |
  ///  meow::Cursor::SizeTopRight           |  yes  |    yes** |   yes**  |
  ///  meow::Cursor::SizeBottomLeft         |  yes  |    yes** |   yes**  |
  ///  meow::Cursor::SizeBottomRight        |  yes  |    yes** |   yes**  |
  ///  meow::Cursor::SizeAll                |  yes  |    no    |   yes    |
  ///  meow::Cursor::Cross                  |  yes  |    yes   |   yes    |
  ///  meow::Cursor::Help                   |  yes  |    yes*  |   yes    |
  ///  meow::Cursor::NotAllowed             |  yes  |    yes   |   yes    |
  ///
...
public:
  ...
  /// (see meow::Cursor::Type) to know whether a given cursor is
...
private:
  ...
  ///
  /// This is primarily designed for meow::Window::setMouseCursor,
...
/// cursor can be changed with meow::Window::setMouseCursor().
///
...
///
/// meow::Cursor cursor;
/// if (cursor.loadFromSystem(meow::Cursor::Hand))
///     window.setMouseCursor(cursor);
/// \endcode
///
/// \see meow::Window::setMouseCursor
///
////////////////////////////////////////////////////////////
