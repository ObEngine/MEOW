...
#include <meow/Window/Keyboard.hpp>
#include <meow/Window/Mouse.hpp>
...
/// \ingroup window
///
/// meow::Event holds all the informations about a system event
/// that just happened. Events are retrieved using the
/// meow::Window::pollEvent and meow::Window::waitEvent functions.
///
/// A meow::Event instance contains the type of the event
...
///     if ((event.type == meow::Event::KeyPressed) && (event.key.code ==
///     meow::Keyboard::Escape))
///         window.close();
///
///     // The window was resized
///     if (event.type == meow::Event::Resized)
