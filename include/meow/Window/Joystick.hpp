...
/// \ingroup window
///
/// meow::Joystick provides an interface to the state of the
...
/// and JoystickButtonReleased events, meow::Joystick can retrieve the
...
///
/// SFML supports:
/// \li 8 joysticks (meow::Joystick::Count)
/// \li 32 buttons per joystick (meow::Joystick::ButtonCount)
/// \li 8 axes per joystick (meow::Joystick::AxisCount)
///
...
/// you must call meow::Joystick::update explicitly.
///
/// Usage example:
/// \code
/// // Is joystick #0 connected?
/// bool connected = meow::Joystick::isConnected(0);
///
/// // How many buttons does joystick #0 support?
/// unsigned int buttons = meow::Joystick::getButtonCount(0);
///
/// // Does joystick #0 define a X axis?
/// bool hasX = meow::Joystick::hasAxis(0, meow::Joystick::X);
///
/// // Is button #2 pressed on joystick #0?
/// bool pressed = meow::Joystick::isButtonPressed(0, 2);
///
/// // What's the current position of the Y axis on joystick #0?
/// float position = meow::Joystick::getAxisPosition(0, meow::Joystick::Y);
/// \endcode
///
/// \see meow::Keyboard, meow::Mouse
///
////////////////////////////////////////////////////////////
