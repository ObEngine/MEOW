...
/// \ingroup window
///
/// meow::Keyboard provides an interface to the state of the
...
/// meow::Keyboard can retrieve the state of a key at any time
...
/// Usage example:
/// \code
/// if (meow::Keyboard::isKeyPressed(meow::Keyboard::Left))
/// {
///     // move left...
/// }
/// else if (meow::Keyboard::isKeyPressed(meow::Keyboard::Right))
/// {
///     // move right...
/// }
/// else if (meow::Keyboard::isKeyPressed(meow::Keyboard::Escape))
/// {
///     // quit...
/// }
/// \endcode
///
/// \see meow::Joystick, meow::Mouse, meow::Touch
///
////////////////////////////////////////////////////////////
