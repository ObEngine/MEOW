...
/// \ingroup window
///
/// meow::Mouse provides an interface to the state of the
...
/// and MouseButtonReleased events, meow::Mouse can retrieve the
...
/// Usage example:
/// \code
/// if (meow::Mouse::isButtonPressed(meow::Mouse::Left))
/// {
///     // left click...
/// }
///
/// // get global mouse position
/// meow::Vector2i position = meow::Mouse::getPosition();
///
/// // set mouse position relative to a window
/// meow::Mouse::setPosition(meow::Vector2i(100, 200), window);
/// \endcode
///
/// \see meow::Joystick, meow::Keyboard, meow::Touch
///
////////////////////////////////////////////////////////////
