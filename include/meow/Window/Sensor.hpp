...
/// \ingroup window
///
/// meow::Sensor provides an interface to the state of the
...
/// its events. Compared to the SensorChanged event, meow::Sensor
...
/// meow::Sensor::isAvailable function.
///
...
/// all disabled by default. You must call meow::Sensor::setEnabled for each
/// sensor in which you are interested.
///
/// Usage example:
/// \code
/// if (meow::Sensor::isAvailable(meow::Sensor::Gravity))
/// {
///     // gravity sensor is available
/// }
///
/// // enable the gravity sensor
/// meow::Sensor::setEnabled(meow::Sensor::Gravity, true);
///
/// // get the current value of gravity
/// meow::Vector3f gravity = meow::Sensor::getValue(meow::Sensor::Gravity);
/// \endcode
///
////////////////////////////////////////////////////////////
