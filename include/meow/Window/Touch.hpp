...
/// \ingroup window
///
/// meow::Touch provides an interface to the state of the
...
/// and TouchEnded events, meow::Touch can retrieve the
...
/// Usage example:
/// \code
/// if (meow::Touch::isDown(0))
/// {
///     // touch 0 is down
/// }
///
/// // get global position of touch 1
/// meow::Vector2i globalPos = meow::Touch::getPosition(1);
///
/// // get position of touch 1 relative to a window
/// meow::Vector2i relativePos = meow::Touch::getPosition(1, window);
/// \endcode
///
/// \see meow::Joystick, meow::Keyboard, meow::Mouse
///
////////////////////////////////////////////////////////////
