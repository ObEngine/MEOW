...
///
/// meow::VideoMode provides a static function for retrieving
...
///
/// Additionally, meow::VideoMode provides a static function
...
/// std::vector<meow::VideoMode> modes = meow::VideoMode::getFullscreenModes();
/// for (std::size_t i = 0; i < modes.size(); ++i)
/// {
///     meow::VideoMode mode = modes[i];
///     std::cout << "Mode #" << i << ": "
...
/// meow::VideoMode desktop = meow::VideoMode::getDesktopMode();
/// window.create(meow::VideoMode(1024, 768, desktop.bitsPerPixel), "SFML
/// window"); \endcode
///
////////////////////////////////////////////////////////////
