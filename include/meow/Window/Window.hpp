...
///
////////////////////////////////////////////////////////////
class Window : public WindowBase, GlResource {
public:
  ////////////////////////////////////////////////////////////
  ...
  /// but since it internally uses meow::sleep, whose precision
...
/// \ingroup window
///
/// meow::Window is the main class of the Window module. It defines
/// an OS window that is able to receive an OpenGL rendering.
///
/// A meow::Window can create its own new window, or be embedded into
...
///
/// The meow::Window class provides a simple interface for manipulating
...
/// OpenGL context attached to the window, with the meow::ContextSettings
...
/// meow::Window window(meow::VideoMode(800, 600), "SFML window");
///
