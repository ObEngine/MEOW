...
#include <meow/Window/WindowHandle.hpp>
#include <meow/Window/WindowStyle.hpp>
...
public:
  ...
  /// style %Window style, a bitwise OR combination of meow::Style enumerators
  ///
  ////////////////////////////////////////////////////////////
  ...
  ///
  /// After calling this function, the meow::Window instance remains
  ...
  ///
  /// \see meow::Cursor::loadFromSystem
  /// \see meow::Cursor::loadFromPixels
  ///
  ////////////////////////////////////////////////////////////
  ...
  ///
  /// The type of the returned handle is meow::WindowHandle,
...
////////////////////////////////////////////////////////////
/// \class meow::WindowBase
/// \ingroup window
///
/// meow::WindowBase serves as the base class for all Windows.
///
/// A meow::WindowBase can create its own new window, or be embedded into
/// an already existing control using the create(handle) function.
///
/// The meow::WindowBase class provides a simple interface for manipulating
...
/// meow::WindowBase window(meow::VideoMode(800, 600), "SFML window");
///
