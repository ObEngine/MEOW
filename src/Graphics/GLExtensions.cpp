...
void ensureExtensionsInit() {
  ...
  if (!initialized) {
    ...
    gladLoadGLES1(reinterpret_cast<GLADloadfunc>(meow::Context::getFunction));
#else
    gladLoadGL(reinterpret_cast<GLADloadfunc>(meow::Context::getFunction));
#endif
    ...
    if (glGetError() == GL_INVALID_ENUM) {
      ...
      if (version) {
        // The beginning of the returned string is "major.minor" (this is
        // standard)
