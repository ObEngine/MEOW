...
#define GLEXT_GL_INVALID_FRAMEBUFFER_OPERATION                                 \
...
#define GLEXT_glBlitFramebuffer                                                \
  glBlitFramebufferEXT // Placeholder to satisfy the compiler, entry point is
                       // not loaded in GLES
...
#define GLEXT_glRenderbufferStorageMultisample                                 \
  glRenderbufferStorageMultisampleEXT // Placeholder to satisfy the compiler,
                                      // entry point is not loaded in GLES
...
#define GLEXT_glCopyBufferSubData                                              \
  glCopyBufferSubData // Placeholder to satisfy the compiler, entry point is not
                      // loaded in GLES
...
#define GLEXT_GL_MAX_COMBINED_TEXTURE_IMAGE_UNITS                              \
