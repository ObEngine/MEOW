...
public:
  ...
  bool loadImageFromFile(const std::string &filename,
                         std::vector<Uint8> &pixels, Vector2u &size);
  ...
  ///
  ////////////////////////////////////////////////////////////
  bool loadImageFromMemory(const void *data, std::size_t dataSize,
                           std::vector<Uint8> &pixels, Vector2u &size);
  ...
  ///
  ////////////////////////////////////////////////////////////
  bool loadImageFromStream(InputStream &stream, std::vector<Uint8> &pixels,
                           Vector2u &size);
  ...
  bool saveImageToFile(const std::string &filename,
                       const std::vector<Uint8> &pixels, const Vector2u &size);
