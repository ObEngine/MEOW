...
////////////////////////////////////////////////////////////
#include <map>
#include <meow/Graphics/RenderTextureImpl.hpp>
...
private:
  ...
  virtual bool create(unsigned int width, unsigned int height,
                      unsigned int textureId, const ContextSettings &settings);
  ...
  // Member data
  ////////////////////////////////////////////////////////////
  std::map<Uint64, unsigned int>
      m_frameBuffers; //!< OpenGL frame buffer objects per context
  std::map<Uint64, unsigned int>
      m_multisampleFrameBuffers; //!< Optional per-context OpenGL frame buffer
                                 //!< objects with multisample attachments
  unsigned int m_depthStencilBuffer; //!< Optional depth/stencil buffer attached
                                     //!< to the frame buffer
  unsigned int m_colorBuffer; //!< Optional multisample color buffer attached to
                              //!< the frame buffer
  ...
  bool m_multisample; //!< Whether we have to create a multisample frame buffer
                      //!< as well
