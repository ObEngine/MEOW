...
#include <meow/Graphics/Shape.hpp>
#include <meow/Graphics/Texture.hpp>
#include <meow/System/Err.hpp>

namespace {
// Compute the normal of a segment
meow::Vector2f computeNormal(const meow::Vector2f &p1,
                             const meow::Vector2f &p2) {
  meow::Vector2f normal(p1.y - p2.y, p2.x - p1.x);
...
float dotProduct(const meow::Vector2f &p1, const meow::Vector2f &p2) {
...
////////////////////////////////////////////////////////////
const Texture *Shape::getTexture() const { return m_texture; }
...
////////////////////////////////////////////////////////////
const IntRect &Shape::getTextureRect() const { return m_textureRect; }
...
////////////////////////////////////////////////////////////
const Color &Shape::getOutlineColor() const { return m_outlineColor; }
...
////////////////////////////////////////////////////////////
FloatRect Shape::getLocalBounds() const { return m_bounds; }
...
Shape::Shape()
    : m_texture(NULL), m_textureRect(), m_fillColor(255, 255, 255),
      ...
      m_vertices(TriangleFan), m_outlineVertices(TriangleStrip),
...
void Shape::updateOutline() {
  ...
  for (std::size_t i = 0; i < count; ++i) {
    ...
    Vector2f p0 =
        (i == 0) ? m_vertices[count].position : m_vertices[index - 1].position;
