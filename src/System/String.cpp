...
////////////////////////////////////////////////////////////
String::String(wchar_t wideChar) { m_string += Utf32::decodeWide(wideChar); }

////////////////////////////////////////////////////////////
String::String(Uint32 utf32Char) { m_string += utf32Char; }
...
String::String(const std::string &ansiString, const std::locale &locale) {
  ...
  Utf32::fromAnsi(ansiString.begin(), ansiString.end(),
                  std::back_inserter(m_string), locale);
}
...
String::String(const wchar_t *wideString) {
  if (wideString) {
    ...
    if (length > 0) {
      m_string.reserve(length + 1);
      Utf32::fromWide(wideString, wideString + length,
...
String::String(const std::wstring &wideString) {
  ...
  Utf32::fromWide(wideString.begin(), wideString.end(),
                  std::back_inserter(m_string));
}
...
////////////////////////////////////////////////////////////
String::operator std::wstring() const { return toWideString(); }
...
std::string String::toAnsiString(const std::locale &locale) const {
  ...
  // Convert
  Utf32::toAnsi(m_string.begin(), m_string.end(), std::back_inserter(output), 0,
                locale);
...
std::wstring String::toWideString() const {
  ...
  // Convert
  Utf32::toWide(m_string.begin(), m_string.end(), std::back_inserter(output),
                0);
...
////////////////////////////////////////////////////////////
std::basic_string<Uint32> String::toUtf32() const { return m_string; }
...
////////////////////////////////////////////////////////////
Uint32 String::operator[](std::size_t index) const { return m_string[index]; }

////////////////////////////////////////////////////////////
Uint32 &String::operator[](std::size_t index) { return m_string[index]; }
...
////////////////////////////////////////////////////////////
bool String::isEmpty() const { return m_string.empty(); }
...
////////////////////////////////////////////////////////////
const Uint32 *String::getData() const { return m_string.c_str(); }
