...
meow::ThreadLocalPtr<meow::Context> currentContext(NULL);
} // namespace ContextImpl
} // namespace
...
const Context *Context::getActiveContext() {
  ...
  // We have to check that the last activated meow::Context is still active (a
  // RenderTarget activation may have deactivated it)
  if (currentContext &&
...
////////////////////////////////////////////////////////////
Context::Context(const ContextSettings &settings, unsigned int width,
                 unsigned int height) {
