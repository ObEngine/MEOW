...
#include <meow/Window/EGLCheck.hpp>
...
void eglCheckError(const char *file, unsigned int line,
  ...
  if (errorCode != EGL_SUCCESS) {
    ...
    case EGL_NOT_INITIALIZED: {
      ...
      description = "EGL is not initialized, or could not be initialized, for "
    ...
    case EGL_BAD_ACCESS: {
      ...
      description = "EGL cannot access a requested resource (for example, a "
    ...
    case EGL_BAD_ATTRIBUTE: {
      ...
      description = "an unrecognized attribute or attribute value was passed "
    ...
    case EGL_BAD_CURRENT_SURFACE: {
      ...
      description = "the current surface of the calling thread is a window, "
                    "pbuffer, or pixmap that is no longer valid";
      break;
    }
    ...
    case EGL_BAD_DISPLAY: {
      ...
      description = "an EGLDisplay argument does not name a valid EGLDisplay; "
                    "or, EGL is not initialized on the specified EGLDisplay";
      break;
    }

    case EGL_BAD_SURFACE: {
      error = "EGL_BAD_SURFACE";
      description = "an EGLSurface argument does not name a valid surface "
                    "(window, pbuffer, or pixmap) configured for rendering";
      break;
    }

    case EGL_BAD_MATCH: {
      error = "EGL_BAD_MATCH";
      description = "arguments are inconsistent; for example, an otherwise "
                    "valid context requires buffers (e.g. depth or stencil) "
                    "not allocated by an otherwise valid surface";
      break;
    }
    ...
    case EGL_CONTEXT_LOST: {
      ...
      description = "a power management event has occurred. The application "
                    "must destroy all contexts and reinitialize client API "
