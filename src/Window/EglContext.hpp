...
#include <meow/Window/WindowStyle.hpp> // Prevent conflict with macro None from Xlib
...
public:
  ...
  ///
  ////////////////////////////////////////////////////////////
  static EGLConfig getBestConfig(EGLDisplay display, unsigned int bitsPerPixel,
