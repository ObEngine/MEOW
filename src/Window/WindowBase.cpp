...
#include <meow/Window/ContextSettings.hpp>
#include <meow/Window/WindowBase.hpp>
#include <meow/Window/WindowImpl.hpp>

namespace {
// A nested named namespace is used here to allow unity builds of SFML.
namespace WindowsBaseImpl {
const meow::WindowBase *fullscreenWindow = NULL;
}
} // namespace
...
void WindowBase::create(VideoMode mode, const String &title, Uint32 style) {
  ...
  if (style & Style::Fullscreen) {
    ...
    if (getFullscreenWindow()) {
      err() << "Creating two fullscreen windows is not allowed, switching to "
               "windowed mode"
            << std::endl;
      ...
      if (!mode.isValid()) {
        err() << "The requested video mode is not available, switching to a "
                 "valid mode"
              << std::endl;
...
// Check validity of style according to the underlying platform
  ...
  m_impl = priv::WindowImpl::create(
      mode, title, style, ContextSettings(0, 0, 0, 0, 0, 0xFFFFFFFF, false));
...
////////////////////////////////////////////////////////////
bool WindowBase::isOpen() const { return m_impl != NULL; }
...
////////////////////////////////////////////////////////////
Vector2u WindowBase::getSize() const { return m_size; }
...
////////////////////////////////////////////////////////////
void WindowBase::setIcon(unsigned int width, unsigned int height,
                         const Uint8 *pixels) {
  if (m_impl)
...
////////////////////////////////////////////////////////////
bool WindowBase::hasFocus() const { return m_impl && m_impl->hasFocus(); }
...
////////////////////////////////////////////////////////////
bool WindowBase::createVulkanSurface(const VkInstance &instance,
                                     VkSurfaceKHR &surface,
                                     const VkAllocationCallbacks *allocator) {
  return m_impl ? m_impl->createVulkanSurface(instance, surface, allocator)
                : false;
}
...
void WindowBase::initialize() {
  // Setup default behaviors (to get a consistent behavior across different
  // implementations)
  setVisible(true);
