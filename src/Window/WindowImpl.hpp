...
#include <meow/Window/JoystickImpl.hpp>
#include <meow/Window/Sensor.hpp>
#include <meow/Window/SensorImpl.hpp>
...
private:
  ...
  JoystickState
      m_joystickStates[Joystick::Count]; //!< Previous state of the joysticks
  Vector3f m_sensorValue[Sensor::Count]; //!< Previous value of the sensors
  float m_joystickThreshold; //!< Joystick threshold (minimum motion for "move"
                             //!< event to be generated)
  float m_previousAxes[Joystick::Count]
                      [Joystick::AxisCount]; //!< Position of each axis last
                                             //!< time a move event triggered,
                                             //!< in range [-100, 100]
};
